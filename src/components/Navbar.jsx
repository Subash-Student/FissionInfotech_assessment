...
export default function Navbar() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full z-50 border-b border-gray-300 bg-white text-black transition-colors duration-300"
    >
      {/* NAVBAR */}
      <nav className="flex justify-evenly items-center px-10 py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <motion.button
            ...
            className="px-5 py-3 rounded-md font-bold text-xl select-none bg-black text-white transition-colors duration-300"
          >
            Contact
          </motion.button>
        </div>
      ...
      <AnimatePresence>
        {activeMenu && (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="flex justify-center gap-6 px-10 pb-8 backdrop-blur-md bg-white/80 transition-colors duration-300"
